        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YoutubeInfo = table.Column<string>(nullable: true),
                    GoogleMapsInfo = table.Column<string>(nullable: true),
                    SpotifyInfo = table.Column<string>(nullable: true),
                    ToDoListMakerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesComplete", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "NotesInProgress",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesInProgress", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notes_ToDoListMakers_ToDoListMakerId",
                        column: x => x.ToDoListMakerId,
                        principalTable: "ToDoListMakers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notes_ToDoListMakerId",
                table: "Notes",
                column: "ToDoListMakerId");
